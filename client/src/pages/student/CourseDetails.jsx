...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating,calculateChapterTime,
        calculateCourseDuration,calculateNoOfLecture,currency,
  ...
  return courseData ? (
    ...
    relative items-start justify-between md:pt-30 pt-20 text-left sm:px-14 lg:px-40'>
    ...
    bg-gradient-to-b from-cyan-100/70'></div>
                                ...
                                text-gray-800 text-xs md:text-default'>
                                  ...
                                  <div className='flex gap-2'>
                                    {lecture.isPreviewFree && <p onClick={()=> setPlayerData({
                                      vedioId:lecture.lectureUrl.split('/').pop()
                                    })}
      ...
      rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
         {
              playerData ? 
                <YouTube videoId={playerData.vedioId} 
        ...
        <div className='p-5'>
          ...
          md:text-default gap-4 pt-2md:pt-4 text-gray-500'>
          ...
          <div className='pt-6'>
            ...
            list-disc text-gray-500'>
              ...
              <li>Step-by-step, hands-on projext guidence.</li>
              <li>Downloadable resources and source code.</li>
              <li>Quizzes to test your konwledge.</li>
