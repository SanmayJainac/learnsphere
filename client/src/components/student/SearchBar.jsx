  ...
  return (
      ...
      border border-grey-500/20 rounded '>
        <img src={assets.search_icon} alt="search_icon" 
         ...
         type="text" placeholder='Search courses' className='w-full
          h-full outline-none text-gray-600/85 ' />
          <button type='submit' className='bg-blue-700 rounded text-white md:px-10
